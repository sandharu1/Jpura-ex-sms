...
<div class="container">
  ...
  <div class="row">
        <h3>Download Pre-formatted student list </h3><small>(.xmls and .csv files)</small>
      <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ route('Marks.store', ['type'=>'3']) }}" class="form-horizontal" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
        {{ csrf_field() }}
